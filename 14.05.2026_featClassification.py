...
# =========================================================
# 24) CLASSIFICATION - BAŞARILI / BAŞARISIZ TAHMİNİ
# =========================================================

# 60 ve üzeri not alan öğrenciler başarılı kabul edilir
df["Basarili_Mi"] = (df["Ortak_Basari_100"] >= 60).astype(int)

# Classification için aynı X değişkenleri kullanılır
X_cls = df[sayisal_ozellikler + kategorik_ozellikler].copy()
y_cls = df["Basarili_Mi"].copy()
...
print("\n--- CLASSIFICATION MODEL KARŞILAŞTIRMA TABLOSU ---")
print(classification_results_df.round(3).to_string(index=False))

best_cls_model = classification_results_df.loc[0, "Model"]

print("\n--- EN İYİ CLASSIFICATION MODELİ ---")
